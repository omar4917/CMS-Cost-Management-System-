...
NAV_SECTIONS = [
    (
        "OPERATIONS",
        [
            ("dashboard", "OV", "Overview", "System health, budget, and activity."),
            ("projects", "PR", "Projects", "Track delivery, units, and capital."),
            ("costs", "CO", "Costs", "Materials, labor, and vendor spending."),
            ("contractors", "VN", "Contractors", "Profiles and payout control."),
        ],
    ),
    (
        "FINANCE",
        [
            ("investors", "IN", "Investors", "Profiles and payment exposure."),
            ("investments", "TX", "Transactions", "Record buy, sell, cost, and funding flows."),
            ("payments", "SC", "Schedules", "Upcoming and overdue installments."),
            ("transactions", "LG", "Ledger", "Unified money-in and money-out."),
            ("reports", "RP", "Reports", "Exports, statements, and PDFs."),
        ],
    ),
    (
        "SYSTEM",
        [
            ("emails", "EM", "Email", "Manual outreach and templates."),
            ("ai", "AI", "Assistant", "Natural-language data operations."),
            ("audit", "AT", "Audit", "Change history and accountability."),
            ("datahub", "BK", "Data Hub", "Backups and portable data."),
            ("settings", "ST", "Settings", "App, finance, and connection setup."),
        ],
    ),
]
...
VIEW_META = {
    ...
    "investments": ("Transactions", "Record investments, sales, buys, and operating cash flow."),
